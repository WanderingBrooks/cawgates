...
import { cn, RESERVED_SLUGS } from '@/lib/utils';
...
const NavMenu = ({ disabled = false, archetypeName }: NavMenuProps) => {
  ...
  const archetypeSlug =
    segments[1] && !RESERVED_SLUGS.includes(segments[1])
      ? segments[1]
      : undefined;
          ...
          {viewerUsername !== null && (
            <>
              <Link
                ...
                className={cn(
                  classes.item,
                  pathname.startsWith(`/${viewerUsername}/events`) &&
                    classes.itemActive,
                )}
              ...
              <Link
                ...
                className={cn(
                  classes.item,
                  pathname.startsWith(`/${viewerUsername}/archetypes`) &&
                    classes.itemActive,
                )}
                onClick={() => setOpen(false)}
              >
          ...
          {!isOwner && (
            <>
              <Link
                ...
                className={cn(
                  classes.item,
                  pathname.startsWith(`/${username}/events`) &&
                    classes.itemActive,
                )}
                onClick={() => setOpen(false)}
              >
              ...
              <Link
                ...
                className={cn(
                  classes.item,
                  pathname.startsWith(`/${username}/archetypes`) &&
                    classes.itemActive,
                )}
                onClick={() => setOpen(false)}
              >
